...
//        die();
    ...
    {
//        var_dump($this->projects[0]->attachment()->latest()->first());
//        die();
...
//                TD::make('model_file', 'Model'),
                ...
                TD::make('model_file', 'Model')->render(fn (Project $model) => // Please use view('path')
                    $model->attachments()->latest()->first() ? "<a href='{$model->attachments()->latest()->first()->url()}'>{$model->attachment()->latest()->first()->original_name}</a>" : ""),
